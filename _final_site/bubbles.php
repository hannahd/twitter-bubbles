    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			...
			tId=setInterval(function() {
				...
				pjs.createBubbles($('body').width(),$('body').height()-<?php echo $header_height+10;?>, javascript_array, false);
			...
			/*http://www.dimensionedelta.net/block/2012/06/popup-modal-windows-dialog-box-made-easy/*/
			$('body').addClass('behind').append(
				'<div class="curtain">'+
					'<div class="modal">'+
						'<h1>Welcome</h1>'+
						'<div class="content">'+
							'<table>'+
								'<tr><td><img src="img/intro-tb.png" alt="Twitter Bubbles Intro"/></td><td>Twitter Bubbles randomly arranges the last 200 tweets from your timeline and emphasizes quieter tweeters.</td></tr>'+
								'<tr><td><img src="img/intro-tint.png" alt="Bubbles from light (older) to dark (newer)"/></td><td>Newer tweets appear darker.</td></tr>'+
								'<tr><td><img src="img/intro-scale.png" alt="Bigger bubbles (quieter people) to smaller bubbles (louder people)"/></td><td>Tweets from quieter folk (people with lower average tweets per day) get bigger bubbles.</td></tr>'+
								'<tr><td><img src="img/intro-rollover.png" alt="Rollover bubble"/></td><td>Rollover a bubble to see the tweet.</td></tr>'+
								'<tr><td><img src="img/intro-twitter.png" alt="Twitter logo"/></td><td>Click a bubble to jump over to Twitter.</td></tr>'+
							'</table>'+
							'<div class="centered"><a href="" class="button close">start bubblin\'</a></div>'+
							'<div class="centered"><a class="alt" href="bubbles-with-people.php">view bubbles with profile pictures</a></div>'+
						'</div>'+
					'</div>'+
				'</div>');

			$(document).on('click', '.curtain, .close', function(e) {
			    e.preventDefault();
